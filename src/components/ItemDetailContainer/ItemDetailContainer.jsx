...
function ItemDetailContainer() {
  ...
  function handleAddToCart(clickCount) {
    ...
    AlertaDulce.fire({
      position: "center",
      icon: "success",
      title: `Product successfully added to the shopping cart, quantity: ${clickCount}`,
  ...
  if (errorsText) {
    ...
    return (
      <ContenedorPadre>
        <ContenedorHijo>
          <TextoProducto>
            Detailed Product View: {product.title}
          </TextoProducto>
        ...
        <ContenedorHijo>
          <TextoProducto>
            {product.description} | Price ${product.price} usd.
          </TextoProducto>
          {isAddedToCart ? (
            <Link
              draggable="false"
