...
function Contacto() {
  return (
    <ContenedorPaginaContacto>
      ...
      <TextoContacto>
        Usalo para pedir al admin que agregue algun producto especifico ó
        enviale un saludo.
      </TextoContacto>
      <TextoContacto className="TextChange">
        Filtro AntiSpam: Por favor resolver el CAPTCHA y habilitaremos el boton
        de envio.
      </TextoContacto>
      <FormularioContacto />
      <Link
